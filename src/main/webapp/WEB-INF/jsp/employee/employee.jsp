<%-- 
    Document   : employee
    Created on : Jun 14, 2016, 4:25:13 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function pageSubmit() {
                document.empDetail.action = "${pageContext.request.contextPath}/employee/addEmployeeView";
                document.empDetail.submit();
            }
        </script>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Employee Details List</h1>
                        </div>
                        <div class="panel">
                        <form:form id="empDetail" name="empDetail" class="form-horizontal">
                                

                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="userStatus" class="col-sm-3 control-label">User Status</label>
                                        <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-9 col-sm-offset-3">
                                        <button type="button" class="btn btn-danger btn-labeled fa fa-search fa-2x focus"
                                                aria-pressed="false" onclick="searchUsers();">Search
                                        </button>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        <thead>
                                            <tr> 
                                                <th class="min-tablet">Employee Code</th>
                                                <th class="min-tablet">Employee Name</th>                              
