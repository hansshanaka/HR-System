<%-- 
    Document   : attendanceAuth
    Created on : Jul 29, 2016, 4:53:23 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script>
            function view() {
            document.viewAtten.action = "${pageContext.request.contextPath}/employee/viewEmpAttendances";
            document.viewAtten.submit();
            }
        </script>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Attendance Authorization</h1>
                        </div>
                        <div class="panel">
                            <form id="viewAtten" name="viewAtten" class="form-horizontal" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-9 col-sm-offset-3">
                                            <button type="button" class="btn btn-danger btn-labeled fa fa-search fa-2x focus"
                                                    aria-pressed="false" onclick="return view();">Authorize
                                            </button>
                                            
                                             <button type="button" class="btn btn-danger btn-labeled fa fa-search fa-2x focus"
                                                    aria-pressed="false" onclick="return view();">Reject
                                            </button>
