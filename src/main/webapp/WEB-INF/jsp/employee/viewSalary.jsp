<%-- 
    Document   : viewSalary
    Created on : Oct 13, 2016, 9:19:47 AM
    Author     : Shanaka
--%>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Salary Details</h1>
                                ...
                                <div class="form-group">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" placeholder="Employee Name" class="form-control input-lg"
