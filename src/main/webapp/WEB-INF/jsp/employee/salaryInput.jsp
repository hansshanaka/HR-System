<%-- 
    Document   : salaryInput
    Created on : Oct 20, 2016, 9:28:49 PM
    Author     : Shanaka
--%>
<%-- 
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function closePage() {
            document.authSalary.action = "${pageContext.request.contextPath}/home";
            document.authSalary.submit();
            }
        </script>
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Salary Input </h1>
                        </div>
                        <div class="panel">
                        <form:form id="authSalary" name="authSalary" class="form-horizontal" method="post">
                                        ...
                                        <thead>
                                            <tr>
                                                <tr>
                                                    ...
                                                    <th class="min-tablet">Attend Days</th>                                  
                                                    <th class="min-tablet">Leave Days</th>  
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/employee/salaryInput-datatables.js"></script>
        ...
        <script>
                                                    ...
                                                    $(document).on("click", ":submit", function (e) {
                                                        var val = $(this).val();
                                                        $("#authSalary").submit(function (event) {
                                                            var action = "";
                                                            if (val === "auth") {
                                                                action = "${pageContext.request.contextPath}/employee/salaryInputSave";
                                                                $("#authSalary").attr('action', action);
                                                            } else if (val === "reject") {
                                                                action = "${pageContext.request.contextPath}/emplopyee/rejectSalary";
                                                                $("#authSalary").attr('action', action);
                                                            } else {
                                                                alert("" + val);
