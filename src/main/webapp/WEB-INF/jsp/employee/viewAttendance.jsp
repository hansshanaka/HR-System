<%-- 
    ...
    Created on : Jul 29, 2016, 1:26:55 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        ...
                        <div class="panel">
                        <form:form id="viewAtten" name="viewAtten" class="form-horizontal" method="post">

                            <div class="panel-body">   

                                <div class="form-group">
                                    <label for="user_code" class="col-sm-3 control-label">Employee Name</label>
                                    <div class="col-sm-6">      
                                        ...
                                        <select name="user_code" id="user_code" class="form-control input-lg"> 
                                            <c:forEach var="item" items="${empList}">    
                                                <c:if test="${item.user_code != 'admin'}">
                                                    <option value="${item.user_code}" ${item.user_code == lBal.user_code ? 'selected="selected"' : ''}>${item.name}</option>  
                                                </c:if>  
                                            </c:forEach>
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-9 col-sm-offset-3">
                                        <button type="button" class="btn btn-success btn-labeled fa fa-search fa-2x focus"
                                                aria-pressed="false" onclick="return searchAttendance();">Search
                                        </button>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/employee/attendance-datatables.js"></script>
