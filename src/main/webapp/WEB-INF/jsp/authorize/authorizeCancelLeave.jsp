<%-- 
    Document   : authorizeCancelLeave
    Created on : Oct 8, 2016, 11:09:41 AM
    Author     : Shanaka
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Authorize Cancel Leave</h1>
                        </div>
                        <div class="panel">
                        <form:form id="authCanLeave" name="authCanLeave" class="form-horizontal" method="post">
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/leave/CancelleaveAuth-datatables.js"></script>
                                ...
                                if ($(".scheckboxleave").is(':checked') == false) {
                                    ...
                                    this.checked = false;
                                                    ...
                                                    $(document).on("click", ":submit", function (e) {
                                                        var val = $(this).val();
                                                        $("#authCanLeave").submit(function (event) {
                                                            var action = "";
                                                            if (val === "auth") {
                                                                action = "${pageContext.request.contextPath}/authorize/authCancelLeave";
                                                                $("#authCanLeave").attr('action', action);
                                                            } else if (val === "reject") {
                                                                action = "${pageContext.request.contextPath}/authorize/rejectCancelLeave";
                                                                $("#authCanLeave").attr('action', action);
                                                            } else {
                                                                alert("" + val);
