<%-- 
    Document   : authorizeLeave
    Created on : Oct 6, 2016, 5:35:53 AM
    Author     : Shanaka
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Authorize Pending Leave</h1>
                        </div>
                        <div class="panel">
                        <form:form id="authLeave" name="authLeave" class="form-horizontal" method="post">
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/leave/leaveAuth-datatables.js"></script>
                                ...
                                if ($(".scheckboxleave").is(':checked') == false) {
                                    ...
                                    this.checked = false;
                                                    ...
                                                    $(document).on("click", ":submit", function (e) {
                                                        var val = $(this).val();
                                                        $("#authLeave").submit(function (event) {
                                                            var action = "";
                                                            if (val === "auth") {
                                                                action = "${pageContext.request.contextPath}/authorize/authLeaveSave";
                                                                $("#authLeave").attr('action', action);
                                                            } else if (val === "reject") {
                                                                action = "${pageContext.request.contextPath}/authorize/rejectLeave";
                                                                $("#authLeave").attr('action', action);
                                                            } else {
                                                                alert("" + val);
