<%-- 
    Document   : addUserType
    Created on : Apr 25, 2016, 12:35:56 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script>
            function save() {
            document.userType.action = "${pageContext.request.contextPath}/user/saveUserType";
            document.userType.submit();
//                serializeForm = $("#frmForm").serialize();
//                $.ajax({
//                    url: '${pageContext.request.contextPath}/user/saveUserType',
//                    type: "GET",
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Add User Type</h1>
                        </div>
                        <div class="panel">
                            <form id="userType" name="userType" class="form-horizontal" method="post">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="salutationCode" class="col-sm-3 control-label">User Type</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-9 col-sm-offset-3">
                                            <button type="button" class="btn btn-danger btn-labeled fa fa-search fa-2x focus"
                                                    aria-pressed="false" onclick="return save();">Save
                                            </button>
