<%-- 
    Document   : userStatus
    Created on : May 31, 2016, 1:47:55 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function pageSubmit() {
                document.userStatus.action = "${pageContext.request.contextPath}/userStatus/addUserStatusView";
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">User Status List</h1>
                        </div>
                        <div class="panel">
                        <form:form id="userStatus" name="userStatus" class="form-horizontal">
                                

                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="userStatus" class="col-sm-3 control-label">User Status Name</label>
                                        <div class="col-sm-6">
                                            <select name="userStatusList" id="userStatusList" class="form-control">
                                            <c:forEach var="item" items="${userStatList}">
                                                <option value="${item.status_id}">${item.emp_status}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="min-tablet">Status Code</th>
                                                <th class="min-tablet">Status Name</th>                                  
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/user/user-status-datatables.js"></script>
