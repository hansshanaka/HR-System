<%-- 
    Document   : userType
    Created on : Apr 7, 2016, 2:22:47 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">User Type</h1>
                        </div>
                        <div class="panel">
                            <form id="userType" name="userType" class="form-horizontal" method="post">
                                <input type="hidden" id="typeId" name="typeId" value=""/>

                                <div class="panel-body" id="tid">
                                    <div class="form-group">
                                        <label for="typeID" class="col-sm-3 control-label">User Type ID<span
                                    ...
                                    <div class="form-group">
                                        <label for="type_name" class="col-sm-3 control-label">User Type<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-6">
                                ...
                                <div class="panel-footer">
                                    <div class="row">
                                        <div class="col-sm-9 col-sm-offset-3">
                                            ...
                                            <button type="submit" class="btn btn-default btn-danger fa fa-eraser btn-labeled fa-2x"
                                               id="delete" onclick="deleteRecord();" style="display:none;" value="Delete">
                                                Delete User Type</button>
                                ...
                                <div class="panel">
                                    <div class="panel-body">
                                        <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="min-tablet">Type ID</th>
                                                    <th class="min-tablet">Type Name</th>                                  
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/user/user-datatables.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/custom/user/user-form-validator.js"></script>
        ...
        var val = $(this).val();
        $("#userType").submit(function (event) {
            var action = "";
            if (val === "Save") {
                action = "${pageContext.request.contextPath}/user/saveUserType";
                $("#userType").attr('action', action);
            } else if (val === "Edit") {
                action = "${pageContext.request.contextPath}/user/editUserType";
                $("#userType").attr('action', action);
            }else if (val === "Delete") {
                action = "${pageContext.request.contextPath}/user/deleteUserType";
                $("#userType").attr('action', action);
            } else {
                alert("" + val);
