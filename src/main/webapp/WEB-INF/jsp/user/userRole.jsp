<%-- 
    Document   : userRole
    Created on : Apr 28, 2016, 12:31:39 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function pageSubmit() {
                document.userRole.action = "${pageContext.request.contextPath}/user/addUserRoleView";
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">User Role List</h1>
                        </div>
                        <div class="panel">
                        <form:form id="userRole" name="userRole" class="form-horizontal" method="post" modelAttribute="userRoleDetails">
                                ...
                                <div class="row">
                                    <div class="col-sm-9 col-sm-offset-3">
                                        <button type="button" class="btn btn-danger btn-labeled fa fa-search fa-2x focus"
                                                aria-pressed="false" onclick="searchUserRole();">Search
                                        </button>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="min-tablet">Role ID</th>
                                                <th class="min-tablet">Role Name</th>                                  
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/user/user-role-datatables.js"></script>
