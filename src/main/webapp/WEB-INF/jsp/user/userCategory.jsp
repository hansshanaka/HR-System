<%-- 
    Document   : userList
    Created on : May 30, 2016, 3:18:15 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function pageSubmit() {
                document.userCategory.action = "${pageContext.request.contextPath}/userCategory/addUserCategory";
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">User Category List</h1>
                        </div>
                        <div class="panel">
                        <form:form id="userCategory" name="userCategory" class="form-horizontal">
                                

                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="userCatList" class="col-sm-3 control-label">User Category Code</label>
                                        <div class="col-sm-6">
                                            <select name="userCatList" id="userCatList" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-sm-9 col-sm-offset-3">
                                        <button type="button" class="btn btn-danger btn-labeled fa fa-search fa-2x focus"
                                                aria-pressed="false" onclick="searchUserCat();">Search
                                        </button>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="min-tablet">Category Code</th>
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/user/user-category-datatales.js"></script>
