<%-- 
    ...
    Created on : Sep 7, 2016, 3:08:55 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function closePage() {
                document.userPReset.action = "${pageContext.request.contextPath}/home";
                document.userPReset.submit();
            }
        </script>
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Employee Password Reset</h1>
                        </div>
                        <div class="panel">
                            <form id="userPReset" name="userPReset" class="form-horizontal" method="post">
                               
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="userCode" class="col-sm-3 control-label">User Code<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="User Code" class="form-control input-lg"
                                                   id="user_code" name="user_code" readonly>
                                        </div>
                                    </div>   
                                    <div class="form-group">
        ...
        var val = $(this).val();
        $("#userPReset").submit(function (event) {
            var action = "";
            if (val === "Save") {
                    action = "${pageContext.request.contextPath}/employee/updateUser";
                    $("#userPReset").attr('action', action);                
            } else {
