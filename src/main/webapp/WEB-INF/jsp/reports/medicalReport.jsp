<%-- 
    ...
    Created on : Oct 18, 2016, 1:03:15 PM
    Author     : Shanaka
--%>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Medical Reimbursement Report</h1>                           
                        </div>
                        <div class="panel">
                        <form:form id="medicalRep" name="medicalRep" class="form-horizontal" method="post">
...
<!--
    ...
    var val = $(this).val();
    $("#medicalRep").submit(function (event) {
        var action = "";
        if (val === "view") {
            action = "${pageContext.request.contextPath}/report/medicalRepPdf";
            $("#medicalRep").attr('action', action);
        } else if (val === "download") {
            action = "${pageContext.request.contextPath}/report/downMedicalRepPdf";
            $("#medicalRep").attr('action', action);
        } else {
            alert("" + val);
