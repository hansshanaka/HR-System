<%-- 
    ...
    Created on : Oct 17, 2016, 1:34:38 PM
    Author     : Shanaka
--%>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Project Report Generate</h1>                           
                        </div>
                        <div class="panel">
                        <form:form id="projectRep" name="projectRep" class="form-horizontal" method="post">
...
<!--
    ...
    var val = $(this).val();
    $("#projectRep").submit(function (event) {
        var action = "";
        if (val === "view") {
            action = "${pageContext.request.contextPath}/report/projectPdf";
            $("#projectRep").attr('action', action);
        } else if (val === "download") {
            action = "${pageContext.request.contextPath}/report/downProjectPdf";
            $("#projectRep").attr('action', action);
        } else {
            alert("" + val);
