<%-- 
    ...
    Created on : Oct 24, 2016, 8:41:28 AM
    Author     : Shanaka
--%>
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Employee Attendance Report Generate</h1>                           
                        </div>
                        <div class="panel">
                        <form:form id="empAttenRep" name="empAttenRep" class="form-horizontal" method="post">
                            ...
                            <div class="panel-body">   
                                ...
                                <div class="form-group">
                                    <label for="type_name" class="col-sm-3 control-label">From Date</label>
        ...
        <script>
            ...
            $(document).on("click", ":submit", function (e) {
                ...
                if (sDate == "" && eDate == "") {
                    $("#empAttenRep").submit(function (event) {
                        var action = "";
                        if (val === "view") {
                            action = "${pageContext.request.contextPath}/report/empAttendancePdf?day=" + day;
                            $("#empAttenRep").attr('action', action);
                        } else {
                            alert("" + val);
