<%-- 
    ...
    Created on : Oct 23, 2016, 7:54:52 PM
    Author     : Shanaka
--%>
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Employee Salary Report Generate</h1>                           
                        </div>
                        <div class="panel">
                        <form:form id="empSalaryRep" name="empSalaryRep" class="form-horizontal" method="post">
        ...
        <script>
            ...
            $(document).on("click", ":submit", function (e) {
                ...
                if (sDate == "" && eDate == "") {
                    $("#empSalaryRep").submit(function (event) {
                        var action = "";
                        if (val === "view") {
                            action = "${pageContext.request.contextPath}/report/empSalaryPdf";
                            $("#empSalaryRep").attr('action', action);
                        } else {
                            alert("" + val);
