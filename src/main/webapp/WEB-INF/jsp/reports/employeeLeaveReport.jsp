<%-- 
    Document   : empLeaveReport
    Created on : Oct 16, 2016, 7:34:28 PM
    Author     : Shanaka
--%>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Employee Leave Report Generate</h1>                           
                        </div>
                        <div class="panel">
                        <form:form id="empLeaveRep" name="empLeaveRep" class="form-horizontal" method="post">
                            ...
                            <div class="panel-body">   
                                ...
                                <div class="form-group">
                                    <label for="type_name" class="col-sm-3 control-label">Date</label>
...
<!--
    ...
    var val = $(this).val();
    $("#empLeaveRep").submit(function (event) {
        var action = "";
        if (val === "view") {
            action = "${pageContext.request.contextPath}/report/empLeavePdf";
            $("#empLeaveRep").attr('action', action);
        } else if (val === "download") {
            action = "${pageContext.request.contextPath}/report/downEmpLeavePdf";
            $("#empLeaveRep").attr('action', action);
        } else {
            alert("" + val);
