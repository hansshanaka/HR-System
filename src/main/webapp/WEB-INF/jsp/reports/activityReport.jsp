<%-- 
    ...
    Created on : Oct 12, 2016, 3:27:26 PM
    Author     : Shanaka
--%>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">User Activity Log</h1>                           
                        </div>
                        <div class="panel">
                        <form:form id="activityRep" name="activityRep" class="form-horizontal" method="post">
                            ...
                            <div class="panel-body">   
                                ...
                                <div class="form-group">
                                    <label for="type_name" class="col-sm-3 control-label">Date<span
...
<!--
    ...
    var val = $(this).val();
    $("#activityRep").submit(function (event) {
        var action = "";
        if (val === "view") {
            action = "${pageContext.request.contextPath}/report/activityLogPdf";
            $("#activityRep").attr('action', action);
        } else if (val === "download") {
            action = "${pageContext.request.contextPath}/report/downActivityLogPdf";
            $("#activityRep").attr('action', action);
        } else {
            alert("" + val);
