<%-- 
    Document   : foodReport
    Created on : Oct 18, 2016, 10:46:34 AM
    Author     : Shanaka
--%>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Food Reimbursement Report</h1>                           
                        </div>
                        <div class="panel">
                        <form:form id="foodRep" name="foodRep" class="form-horizontal" method="post">
...
<!--
    ...
    var val = $(this).val();
    $("#foodRep").submit(function (event) {
        var action = "";
        if (val === "view") {
            action = "${pageContext.request.contextPath}/report/foodRepPdf";
            $("#foodRep").attr('action', action);
        } else if (val === "download") {
            action = "${pageContext.request.contextPath}/report/downFoodRepPdf";
            $("#foodRep").attr('action', action);
        } else {
            alert("" + val);
