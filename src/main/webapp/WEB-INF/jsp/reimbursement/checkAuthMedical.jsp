<%-- 
    Document   : checkAuthMedical
    Created on : Oct 10, 2016, 5:48:30 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Authorized Medical Reimbursement </h1>
                        </div>
                        <div class="panel">
                        <form:form id="checkAuthMedical" name="checkAuthMedical" class="form-horizontal">
        ...
        <script>
            ...
            $('#demo-dt-basic').DataTable().ajax.url(contextPath + "/medicalReimb/authMedicalList").load(); 
