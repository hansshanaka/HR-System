<%-- 
    Document   : addMdical
    Created on : Oct 10, 2016, 7:16:40 AM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function closePage() {
            document.addMedical.action = "${pageContext.request.contextPath}/home";
            document.addMedical.submit();
            }
        </script>
                ...
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            ...
                            <h1 class="page-header text-overflow">Insert Medical Reimbursement Details</h1>
                      
                        </div>
                        <div class="panel">
                        <form:form id="addMedical" name="addMedical" class="form-horizontal" enctype="multipart/form-data"  method="post">
    ...
    <script src="${pageContext.request.contextPath}/resources/js/custom/reimbursement/add-medical-form-validator.js"></script>
    ...
    <script>
                                                ...
                                                $(document).on("click", ":submit", function (e) {
                                                    ...
                                                    if (selected) {
                                                    $("#addMedical").submit(function (event) {
                                                        var action = "";
                                                        if (val === "Save") {
                                                            action = "${pageContext.request.contextPath}/medicalReimb/saveMedical";
                                                            $("#addMedical").attr('action', action);
                                                        } else if (val === "Edit") {
                                                            action = "${pageContext.request.contextPath}/medicalReimb/editMedical";
                                                            $("#addMedical").attr('action', action);
                                                        }  else {
