<%-- 
    Document   : checkTravel
    Created on : Oct 10, 2016, 5:51:21 AM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function deleteTaxi(taxi_id) {
                document.checkTravel.action = "${pageContext.request.contextPath}/travelReimb/deleteTravel/"+taxi_id;
                document.checkTravel.submit();
            }
        </script>
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Cancel Pending Travel Reimbursement Status</h1>
                        </div>
                        <div class="panel">
                        <form:form id="checkTravel" name="checkTravel" class="form-horizontal">
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/reimbursement/check-tavel-datatables.js"></script>
