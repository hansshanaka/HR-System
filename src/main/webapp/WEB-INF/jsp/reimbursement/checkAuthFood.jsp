<%-- 
    Document   : checkAuthFood
    Created on : Oct 10, 2016, 4:32:20 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Authorized Food Reimbursement </h1>
                        </div>
                        <div class="panel">
                        <form:form id="checkAuthFood" name="checkAuthFood" class="form-horizontal">
        ...
        <script>
            ...
            $('#demo-dt-basic').DataTable().ajax.url(contextPath + "/foodReimb/AuthFoodList").load(); 
