<%-- 
    Document   : addFood
    Created on : Oct 9, 2016, 9:16:22 AM
    Author     : Shanaka
--%>
...
<html lang="en">
    ...
    <body>
                    ...
                    <div id="content-container">
                        ...
                        <c:choose>
                            <c:when test="${recordType=='i'}">
                                <h1 class="page-header text-overflow">Insert Food Reimbursement Details</h1>
                            </c:when>
                            <c:when test="${recordType=='e'}">
                                <h1 class="page-header text-overflow">Edit Food Reimbursement Details</h1>
                            </c:when>
                        </c:choose>

                    </div>
                    <div class="panel">
                        <form:form id="addFood" name="addFood" class="form-horizontal" enctype="multipart/form-data"  method="post">
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/reimbursement/add-food-form-validator.js"></script>
                                                    ...
                                                    $(document).on("click", ":submit", function (e) {
                                                        ...
                                                        if (selected) {
                                                            ...
                                                            $("#addFood").submit(function (event) {
                                                                var action = "";
                                                                if (val === "Save") {
                                                                    action = "${pageContext.request.contextPath}/foodReimb/saveFood";
                                                                    $("#addFood").attr('action', action);
                                                                } else if (val === "Edit") {
                                                                    action = "${pageContext.request.contextPath}/foodReimb/editFood";
                                                                    $("#addFood").attr('action', action);
                                                                } else {
