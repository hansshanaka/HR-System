<%-- 
    Document   : checkMedical
    Created on : Oct 10, 2016, 8:07:08 AM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function deleteMedical(medical_id) {
                document.checkMedical.action = "${pageContext.request.contextPath}/medicalReimb/deleteMedical/"+medical_id;
                document.checkMedical.submit();
            }
        </script>
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Cancel Pending Food Reimbursement Status</h1>
                        </div>
                        <div class="panel">
                        <form:form id="checkMedical" name="checkMedical" class="form-horizontal">
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/reimbursement/check-medical-datatables.js"></script>
