<%-- 
    Document   : checkAuthTravel
    Created on : Oct 10, 2016, 5:26:44 PM
    Author     : Shanaka
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Authorized Travel Reimbursement </h1>
                        </div>
                        <div class="panel">
                        <form:form id="checkAuthTravel" name="checkAuthTravel" class="form-horizontal">
                                    ...
                                    <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="min-tablet">Input Date</th>
                                                <th class="min-tablet">Authorized Date</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
        ...
        <script>
            ...
            $('#demo-dt-basic').DataTable().ajax.url(contextPath + "/travelReimb/AuthTravelList").load(); 
