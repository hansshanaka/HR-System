<%-- 
    Document   : checkLeave
    Created on : Oct 5, 2016, 10:56:58 AM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function cancelLeave() {
                document.checkLeave.action = "${pageContext.request.contextPath}/leave/cancelLeave";
                document.checkLeave.submit();
            }
        </script>
    ...
    <body>
            ...
            <jsp:include page="/WEB-INF/jsp/common/header.jsp"></jsp:include>
                <div class="boxed">
                    <div id="content-container">
                        <div id="page-title">
                            <h1 class="page-header text-overflow">Check Leave Status</h1>
                        </div>
                        <div class="panel">
                        <form:form id="checkLeave" name="checkLeave" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="auth_state" class="col-sm-3 control-label">Select Leave Status</label>
                                    <div class="col-sm-6">                                      
                                        <select name="auth_state" id="auth_state" class="form-control input-lg" >                                                    
                                ...
                                <div class="row">
                                    <div class="col-sm-9 col-sm-offset-3">
                                        <button type="button" class="btn btn-info btn-lg btn-labeled fa fa-search fa-lg"
                                                aria-pressed="false" onclick="searchLeave();">Search
                                        </button>
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/leave/check-leave-datatables.js"></script>
