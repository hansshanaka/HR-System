<%-- 
    Document   : applyLeave
    Created on : Sep 27, 2016, 7:34:45 AM
    Author     : Shanaka
--%>
...
<html lang="en">
    <head>
        ...
        <script type="application/javascript">
            ...
            function closePage() {
            document.userDepartment.action = "${pageContext.request.contextPath}/home";
    ...
    <body>
                    ...
                    <div id="content-container">
                        ...
                        <c:choose>
                            <c:when test="${recordType=='i'}">
                                <h1 class="page-header text-overflow">Apply Leave</h1>
                            </c:when>
                            <c:when test="${recordType=='e'}">
                                <h1 class="page-header text-overflow">Edit Leave</h1>
                            </c:when>
                        </c:choose>

                    </div>
                    <div class="panel">
                        <form:form id="leaveForm" name="leaveForm" class="form-horizontal" method="post">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">                                      
                                        <select name="ltype_id" id="ltype_id" class="form-control input-lg" onchange="datePic()">                                                    
                                ...
                                <div class="form-group">
                                    <label for="edate" class="col-sm-3 control-label">End Date<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-6">
                                        <div id="demo-dp-component">
                                            <div class="input-group date pickadate midEdate" id="medED">
                                                <input type="text" path="end_date" id="end_date" name="end_date"
                                                       class="form-control datePicker_custom"
                                                       placeholder="End Date"/>
                                                <span class="input-group-addon"><i class="fa fa-calendar fa-lg"></i></span>
                                            </div>
                                            <div class="input-group date pickadate edate" id="noMedED">
                                                <input type="text" path="end_date" id="end_date" name="end_date"
                                                       class="form-control datePicker_custom"
                                                       placeholder="End Date"/>
                                                <span class="input-group-addon"><i class="fa fa-calendar fa-lg"></i></span>
                                ...
                                <div class="form-group">
                                    <label for="no_of_days" class="col-sm-3 control-label">No of Days<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="No of days" class="form-control input-lg"
                                               id="no_of_days" name="no_of_days" value="">
                                    </div>
                                </div> 
        ...
        <script src="${pageContext.request.contextPath}/resources/js/custom/leave/apply-leave-validator.js"></script>
        ...
        <script>
                                                    ...
                                                    $(document).on("click", ":submit", function (e) {
                                                        ...
                                                        $("#leaveForm").submit(function (event) {
                                                            var action = "";
                                                            if (val === "Save") {
                                                                action = "${pageContext.request.contextPath}/leave/saveLeave";
                                                                $("#leaveForm").attr('action', action);
                                                            } else if (val === "Edit") {
                                                                action = "${pageContext.request.contextPath}/employee/editLeave";
                                                                $("#leaveForm").attr('action', action);
                                                            } else {
                                                                alert("" + val);
     ...
     var optionsMedStartDate = {
        ...
        clearBtn: true
         ...
         if($('#ltype_id').val() == 2){ 
            ...
            $(".midSdate").datepicker(optionsMedStartDate).on('change', function () {}); 
            $(".midEdate").datepicker(optionsMedEndDate).on('change', function () {}); 
         }
